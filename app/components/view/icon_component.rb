class View::IconComponent < ViewComponent::Base
  ...
  private def set_icon(icon_type)
    ...
    when "api"
      icon = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' width='#{@size}' height='#{@size}'><path d='M13 11a1.93 1.93 0 0 0 -1 0.285l-1.545 -1.55a3 3 0 0 0 0 -3.47L12 4.715a1.93 1.93 0 0 0 1 0.285 2 2 0 1 0 -2 -2 1.93 1.93 0 0 0 0.285 1l-1.55 1.545a3 3 0 0 0 -3.47 0L4.715 4A1.93 1.93 0 0 0 5 3a2 2 0 1 0 -2 2 1.93 1.93 0 0 0 1 -0.285l1.545 1.55a3 3 0 0 0 0 3.47L4 11.285A1.93 1.93 0 0 0 3 11a2 2 0 1 0 2 2 1.93 1.93 0 0 0 -0.285 -1l1.55 -1.545a3 3 0 0 0 3.47 0l1.55 1.545a1.93 1.93 0 0 0 -0.285 1 2 2 0 1 0 2 -2Zm0 -9a1 1 0 1 1 -1 1 1 1 0 0 1 1 -1ZM2 3a1 1 0 1 1 1 1 1 1 0 0 1 -1 -1Zm1 11a1 1 0 1 1 1 -1 1 1 0 0 1 -1 1Zm5 -4a2 2 0 1 1 2 -2 2 2 0 0 1 -2 2Zm5 4a1 1 0 1 1 1 -1 1 1 0 0 1 -1 1Z' fill='#{@color}' stroke-width='0.5'></path><path d='M0 0h16v16H0Z' fill='none' stroke-width='0.5'></path></svg>"
    end
    icon.html_safe
  end
end