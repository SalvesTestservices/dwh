    ...
    unless users.blank?
      users.each do |user|
        ...
        unless dim_company.blank?
          ...
          existing_user = Dwh::DimUser.find_by(account_id: dim_account.id, original_id: user.data['original_id'], company_id: dim_company.id)
          if existing_user.blank?
            Dwh::DimUser.create({ account_id: dim_account.id, original_id: user.data['original_id'], full_name: user.data['full_name'], company_id: dim_company.id, 
