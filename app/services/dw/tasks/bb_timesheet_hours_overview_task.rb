class Dwh::Tasks::BbTimesheetHoursOverviewTask < Dwh::Tasks::BaseTask
  queue_as :default
              ...
              timesheets.each do |timesheet|
                ...
                unless activities.blank?
                  activities.each do |activity|
                    ...
                    Dwh::BbTimesheetHourOverview.upsert({ uid: uid, day: activity.day, month: timesheet.month, year: timesheet.year, account_id: account.id, company_id: company.id, user_id: user.id, 
